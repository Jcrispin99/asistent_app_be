    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ultimo_acceso_ip', models.GenericIPAddressField(blank=True, null=True, verbose_name='Última IP')),
                ...
                ('empleado', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='employees.employee', verbose_name='Empleado Asociado')),
